...
const HomeDashboard = () => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen bg-surface-base">
      ...
      <div className="DashBoardStates grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 mt-4">
      ...
      <div className="medium mt-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="topProducts w-full lg:w-[45%] border border-border-subtle bg-surface-card p-5 sm:p-6 lg:p-8 rounded-3xl shadow-xs">
          <h2 className="text-xl sm:text-2xl font-bold font-display text-text-primary">
            Best sellers
          </h2>
